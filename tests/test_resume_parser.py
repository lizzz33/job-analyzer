...
class TestResumeParser:
    ...
    @pytest.mark.asyncio
    async def test_parse_returns_profile_from_llm(self, tmp_path):
        llm_json = json.dumps({
            "name": "Анна Смирнова",
        ...
        profile = await parser.parse(resume_file)
    ...
    @pytest.mark.asyncio
    async def test_parse_empty_file_raises(self, tmp_path):
        from app.services.resume_parser import ResumeParser
    ...
    @pytest.mark.asyncio
    async def test_parse_llm_no_json_returns_fallback(self, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_parse_truncates_long_text(self, tmp_path):
        long_text = "A" * 20000
    ...
    @pytest.mark.asyncio
    async def test_parse_llm_invalid_json_uses_fallback(self, tmp_path):
